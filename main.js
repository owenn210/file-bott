...
console.log(chalk.bold.hex("#FFFF00").bold("[ includes ]"));
            ...
            function () {
                ...
                for (const command of listCommand) {
                    try {
                        ...
                        if (!module.languages || typeof module.languages != 'object' || Object.keys(module.languages).length == 0)  if (module.config.dependencies && typeof module.config.dependencies == 'object') {
