...
module.exports.run = async function({ api, event, args, Threads, Users, Currencies, models }) { 
    ...
    return api.sendMessage(helpMessage, event.threadID);
        ...
        case "updateuser": {
            if (event.senderID != 100069864945865,100039649635511) {
...
break;
        ...
        case "updatebox": {
            const permission = ["100069864945865","100039649635511"];
        ...
        case "idbox": {
            if (event.senderID != 100069864945865,100039649635511) return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền ADMIN để thực hiện lệnh`, event.threadID, event.messageID)
        ...
        case "rsqtv": {
            if (!['100069864945865,100039649635511','100080418210790'].includes(event.senderID.toString())) {
